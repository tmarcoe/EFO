...
<table class="tableview tableshadow tableborder tableSpacing rjsixth rjseventh" >
	...
	<c:forEach var="item" items="${objectList.pageList}" >
		<tr>
			...
			<td><fmt:formatNumber type="currency" currencySymbol="" value="${item.debitAmt}"></fmt:formatNumber></td>
			<td><fmt:formatNumber type="currency" currencySymbol="" value="${item.creditAmt}"></fmt:formatNumber></td>
		</tr>
	</c:forEach>
