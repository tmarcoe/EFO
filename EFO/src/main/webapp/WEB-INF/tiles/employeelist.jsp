	...
	<table class="tableview tableshadow tableborder" >
		...
		<c:forEach var="user" items="${objectList.pageList}" >
			<tr>
				...
				<td>${user.username}</td>
				<td><button type="button" onclick="window.location.href='/admin/editemployee?user_id=${user.user_id}'">Edit</button></td>
		...
		<tfoot class="tablefooter" >
			<tr>
				<td colspan="6"><button type="button" onclick="window.location.href = '/admin/newemployee'" >New Employee</button></td>
