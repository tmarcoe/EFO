...
public class JSONReports {
	...
	public JSONObject JSONCreateSalesReport(List<Double> totals, String reportTitle) throws JSONException {		
	...
	public JSONObject JSONCreateGenderReport(List<Double> genders, String heading) throws JSONException {
	...
	public JSONObject JSONCreateServeyReport(List<Double> answers, String heading) throws JSONException {
	...
	public JSONObject JSONCreateCustomerCount(List<BigInteger> customers, String heading) throws JSONException {
		JSONObject json = new JSONObject();
		JSONObject data = new JSONObject();
		JSONArray datasets = new JSONArray();
		JSONObject dataset = new JSONObject();
	...
	public JSONObject JSONCreateCogsReport( List<Double> cogs, String reportTitle) throws JSONException {		
		JSONObject json = new JSONObject();
		JSONObject data = new JSONObject();
		JSONArray datasets = new JSONArray();
		JSONObject d1 = new JSONObject();
